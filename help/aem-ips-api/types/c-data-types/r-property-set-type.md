...
TQID: https://experienceleague.adobe.com/iPChI-MmEDdlFuu2b4tfs9IX7fOfGpVHR70Wb35PunI
product_v2:
...
<table id="table_04100BB8ABD84EF68B0A7CE3AD946414"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3">Company handle. <p>Note:  The type is global if the company handle is not present. </p></td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> name</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> Type name. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> propertyType</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3">One of Property Set Types. See Input (<span class="codeph"> createPropertySetTypeParam</span>). </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> allowMultiple</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:boolean</span> </td> 
   <td colname="col3"> Whether to allow multiple property set instances to be attached to an object for this type. </td> 
  </tr> 
 </tbody> 
</table>
