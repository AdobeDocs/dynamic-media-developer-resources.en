...
TQID: https://experienceleague.adobe.com/9RkPYHMd8Aj4uNYnZ5-nWpbJs-f9NBZ0oXWWmOzi-0w
product_v2:
...
* If you publish a Dynamic Media video with a URL, you append `SmartCropVideoPlayer.ssl` to the URL. 
...
* If you publish a Dynamic Media video with embed code, you add `SmartCropVideoPlayer.ssl` to the list of other viewer configuration parameters in the embed code snippet. 
