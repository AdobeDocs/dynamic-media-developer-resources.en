...
TQID: https://experienceleague.adobe.com/00tponp9KTiKRNW8Lag-FoIg-3pk5ZCP7uM3qsZV4Ec
product_v2:
...
* If you publish a Dynamic Media video with a URL, you append `Video360Player.ssl` to the URL. 
...
* If you publish a Dynamic Media video with embed code, you add `Video360Player.ssl` to the list of other viewer configuration parameters in the embed code snippet. 
