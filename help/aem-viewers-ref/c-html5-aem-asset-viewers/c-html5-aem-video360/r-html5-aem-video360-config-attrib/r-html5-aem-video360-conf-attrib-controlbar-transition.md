...
TQID: https://experienceleague.adobe.com/KizDEzPGeH1qKjifVdy1eGLltewQfYIObnKdwTRF3rM
product_v2:
...
<table id="table_C616483932C2482CA9794DDD7313FD7C"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Specifies the time in seconds between the last mouse/touch event that the control bar registers and the time control bar hide. </p> <p> If set to <span class="codeph"> -1</span>, the component never triggers its auto-hide effect and always stays visible on the screen. </p> </td> 
  </tr> 
  <tr> 
