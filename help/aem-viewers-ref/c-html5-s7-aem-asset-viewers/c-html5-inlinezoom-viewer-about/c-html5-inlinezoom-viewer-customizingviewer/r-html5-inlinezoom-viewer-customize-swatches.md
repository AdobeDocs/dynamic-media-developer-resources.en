...
TQID: https://experienceleague.adobe.com/70zu75-Z41Um6CPEldzD9kQwMTkg2hHhklRNCyalYp4
product_v2:
...
<table id="table_70FAD50E38EB4647B8FAB832F552BBB8"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> The size of the horizontal and vertical margin around each thumbnail. Actual thumbnail spacing equals to the sum of left and right margin set for <span class="codeph"> .s7thumbcell </span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_85446C72FD914594B7D108381BBFC673"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> width </span> </p> </td> 
   <td colname="col2"> <p> The width of the thumbnail swatches. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> height </span> </p> </td> 
   <td colname="col2"> <p>The height of the thumbnail swatches. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> border </span> </p> </td> 
   <td colname="col2"> <p>The border of the thumbnail swatches. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_F957367566C542829E2F6D296F9DAAC5"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> width </span> </p> </td> 
   <td colname="col2"> <p> The width of the scroll button. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> height </span> </p> </td> 
   <td colname="col2"> <p>The height of the scroll button. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Position inside artwork sprite, if CSS sprites are used. </p> <p>See <a href="../../../c-html5-s7-aem-asset-viewers/c-html5-inlinezoom-viewer-about/c-html5-inlinezoom-viewer-customizingviewer/c-html5-inlinezoom-viewer-customizingviewer.md#section-b0af39db1af74561aea9fddcc8cdc2c7" format="dita" scope="local"> CSS Sprites </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
>[!NOTE]
>
>This button supports the `state` attribute selector, which is used to apply different skins to button states `up`, `down`, `over`, and `disabled`.

The button tool tips can be localized. See [Localization of user interface elements](../../../c-html5-s7-aem-asset-viewers/c-html5-inlinezoom-viewer-about/c-html5-inlinezoom-viewer-localization.md#concept-6c8e58c611934e93ae3f211f46e15c27) for more information.
