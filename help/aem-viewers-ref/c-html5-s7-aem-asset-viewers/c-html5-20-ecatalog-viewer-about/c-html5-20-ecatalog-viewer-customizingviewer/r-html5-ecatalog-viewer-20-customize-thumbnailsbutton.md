...
TQID: https://experienceleague.adobe.com/-MBS42jAnlhZw8F2Y7w0Ng1wifjzmnxO6ASmgNHNka0
product_v2:
...
Selecting or tapping this button resets toggles the viewer between the main view and the thumbnails. This button appears in the main control bar. You can size, skin, and position this button by using CSS.
...
Example - To set up thumbnails button that is 28 x 28 pixels and is positioned 4 pixels from the bottom and 5 pixels from the left edge of the main control bar. And finally, displays a different image for each of the four different button states when selected or not selected.
