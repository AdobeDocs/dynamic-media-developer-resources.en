...
TQID: https://experienceleague.adobe.com/lER7lKnDb4CGYc-g15eTFzsl-em58kMdX8TKbs2VXCg
product_v2:
...
Selecting or tapping this button zooms in on an image in the main view. This button appears in the main control bar. This button is not displayed on mobile phones to save screen real estate. You can size, skin, and position this button by using CSS.
...
Example - To set up a zoom in button that is 28 x 28 pixels and is positioned 4 pixels from the bottom and 103 pixels from the right edge of the main control bar. And finally, displays a different image for each of the four different button states.
