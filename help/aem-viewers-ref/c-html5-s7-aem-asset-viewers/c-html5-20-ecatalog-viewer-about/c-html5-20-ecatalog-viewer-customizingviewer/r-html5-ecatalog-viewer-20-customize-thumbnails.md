...
TQID: https://experienceleague.adobe.com/Omn01Syh1uNk-PwU-uQA1tAr68hcDiM4myTZr9jdRoE
product_v2:
...
If there are more thumbnails than can fit vertically into the view, thumbnails render the vertical scroll bar on the right side. The appearance of scroll bar area is controlled with the following CSS class selector:
...
<table id="table_89E64A138ABF463F9650BB454F22D530"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> height </span> </p> </td> 
   <td colname="col2"> <p>The height of the button. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> background-image </span> </p> </td> 
   <td colname="col2"> <p>The image that is displayed for a given thumb state. </p> </td> 
