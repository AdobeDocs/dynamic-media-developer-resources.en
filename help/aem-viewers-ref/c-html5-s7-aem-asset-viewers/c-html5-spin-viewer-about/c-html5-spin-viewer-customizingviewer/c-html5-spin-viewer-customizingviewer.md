...
TQID: https://experienceleague.adobe.com/Hc0r6ICwBlx4am3qTYt6-v-PcopwYkLdwH-vpPOUQgI
product_v2:
...
To help you create responsive designed CSS, the viewer supports CSS markers which special CSS classes dynamically assigned to the top-level viewer container element. Those classes are based on the run-time viewer size and the input type used on the current device.
