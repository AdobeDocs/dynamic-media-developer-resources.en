...
TQID: https://experienceleague.adobe.com/vuFKdWAFc-VS5glnSSaW3wFdenL-HZfoeMdtc6FRg70
product_v2:
...
<table id="table_896DFF34A68A403DB93A6D597461A573"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>{<span class="codeph"> String</span>} new asset id, single or multi-dimensional spin set with optional Image Serving modifiers appended after <span class="codeph"> ?</span>. </p> <p> Images which use IR (Image Rendering) or UGC (User-Generated Content) are not supported by this viewer. </p> </td> 
  </tr> 
 </tbody> 
</table>
