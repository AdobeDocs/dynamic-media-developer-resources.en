...
The viewer is built of many Viewer SDK components. In most cases, the web page does not need to interact with the SDK components API directly; all common needs are covered in the viewer API itself.
