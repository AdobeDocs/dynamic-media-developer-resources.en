...
TQID: https://experienceleague.adobe.com/FOcJ11okdDEknXSEMV0r1RgAerR3aRQVnZGX4-k15Fk
product_v2:
...
Example - To set up a next page button that is 28 x 28 pixels, and positioned 4 pixels from the bottom and 250 pixels from the right edge of the main control bar. And finally, displays a different image for each of the four different button states.
