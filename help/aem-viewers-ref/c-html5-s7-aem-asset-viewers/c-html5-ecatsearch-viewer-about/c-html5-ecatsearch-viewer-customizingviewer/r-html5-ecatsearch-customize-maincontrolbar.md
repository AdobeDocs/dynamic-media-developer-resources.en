...
description: The main control bar is the rectangular area on desktop systems and tablets that contain all user interface controls (except Large Page buttons) available for the eCatalog Search viewer.
solution: Experience Manager
feature: Dynamic Media Classic,Viewers,SDK/API,eCatalog Search
role: Developer,User
exl-id: cee6a4d4-4099-4bc8-9d67-00a1e963a139
TQID: https://experienceleague.adobe.com/pC5ewDZjkEKGPfZPzcKnFG8jVLns9hYOyrM7EylqSvw
product_v2:
...
<table id="table_2C8D322F57114A72B43053CB4539C65C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>The background color of the main control bar. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_C8225F38309B4099AF58AA1A815A8D55"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>When set to <span class="codeph"> static </span> the scroll feature is disabled. </p> <p>Set this property to <span class="codeph"> absolute </span> to enable the scroll feature. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_2CDDA8A18345497EAC4749A0D64C1658"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Normally should be equal or larger than the width of the scroll button itself. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> background-color </span> </p> </td> 
   <td colname="col2"> <p>Container background color. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
>[!NOTE]
>
>This button supports the `state` and `selected` attribute selectors, which can be used to apply different skins to different button states. In particular, `state="selected"` corresponds to the initial scroll button state when it is possible to scroll control bar contents to the left. The `state="default"` corresponds to the state when the content is scrolled all the way to the left and the scroll button suggests returning it to the initial state.
