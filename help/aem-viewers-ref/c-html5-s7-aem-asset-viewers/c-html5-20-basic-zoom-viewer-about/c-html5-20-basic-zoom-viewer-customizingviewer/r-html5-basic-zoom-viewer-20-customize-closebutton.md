---
title: Close button
description: Selecting this button closes the containing web page. This button only appears if the closebutton parameter is set to 1. You can size, skin, and position this button by using CSS.
solution: Experience Manager
feature: Dynamic Media Classic,Viewers,SDK/API,Zoom
role: Developer,User
exl-id: 73535bf3-7993-442e-b322-b640306a5101
TQID: https://experienceleague.adobe.com/kFsH7jCCtBtH8ztVE3ZIyOIbBiaO1cTgtyNiGwUi5BA
product_v2:
...
Example - to set up a Close button that is 32 x 32 pixels and positioned six pixels from the top and right edge of the viewer. It must display a different image for each of the four different button states.
