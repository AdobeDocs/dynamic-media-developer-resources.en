...
TQID: https://experienceleague.adobe.com/m81hcbV8CU2WXQdbic6OrkDlZMQjAI0-2Xz980FzNw0
product_v2:
...
Using CSS markers is the most flexible way of building CSS for responsive design. The reason is because it lets you target not only the device screen size but the actual viewer size, which is useful for responsive designed layouts.
