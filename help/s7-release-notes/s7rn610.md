...
TQID: https://experienceleague.adobe.com/fTpfbij-XXYUJLfjsYzdrie7kkOUZlBMxHyio5rsksA
product_v2:
...
Viewer upgrades are backwards compatible—no changes are necessary to your existing web code. However, it is recommended that you test the new viewers on Adobe's staging environment.
...
* Fixed an issue where s7sdk.browser.device.version detected fifth Android&trade; incorrectly. 
