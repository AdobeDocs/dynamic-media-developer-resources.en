...
* Monitoring of the Invalidate CDN cache feature. After you have selected your CDN Invalidation Template (see [General Settings](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/setup/application-setup.html#general-settings)), and an **[!UICONTROL Invalidate CDN]** request is made, an indicator now pops up with an estimate of how long it will take to clear the cache.
