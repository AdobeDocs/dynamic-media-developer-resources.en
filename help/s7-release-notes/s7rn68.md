...
See also [Scene7 Viewers Reference Guide](/help/aem-viewers-ref). 
...
* Besides the ability to upload content to Scene7 Publishing System by way of server directory upload (ftp) and upload URLs, you can now also upload content using HTTP POST. See the [Image Production System API](/help/aem-ips-api) for more information on using HTTP POST.
