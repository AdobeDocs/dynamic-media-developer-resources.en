...
seo-description: Release notes that describe the features, enhancements, and fixes for Adobe Scene7 Publishing System 6.0–part of the Adobe Marketing Cloud.
seo-title: Scene7 Publishing System 6.0 Release Notes
...
* New [Scene7 Quick Start video tutorials](http://microsite.omniture.com/t2/help/en_US/home/index.html#Scene7). 
...
* New Flash AS3 viewers include the following:
  ...
  See [Scene7 Publishing System Viewer Library Examples](http://s7viewers.host.adobe.com/vlist.html). 
...
* New HTML5 Viewers include the following:
    ...
    * Image Set 
    * Swatch Set 
    * eCatalog with email friend (DHTML)
...
** *&#42;&#42;Beta feature&#42;&#42;* Metadata and Similarity Search**
...
** ** *&#42;&#42;Beta feature&#42;&#42;*3D RapidRefine** **

This desktop application allows you to import existing 3D models and author them as 2D vignette files. The resulting vignette files can be uploaded to SPS, where colors and textures can be replaced on-demand.

*This new technology is currently in beta, and requires development work. Contact the Scene7 support team ( [s7support@adobe.com](mailto:s7support@adobe.com)) to join the beta program and test in a secure environment.*
